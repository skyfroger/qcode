...
function hasOwnPropertyDebugg(obj, prop) {
...
Sk.Debugger.prototype.move_up_the_stack = function () {
    this.current_suspension = Math.min(
        this.current_suspension + 1,
        this.suspension_stack.length - 1,
    );
};
...
Sk.Debugger.prototype.generate_breakpoint_key = function (
    filename,
    lineno,
    colno,
) {
...
Sk.Debugger.prototype.check_breakpoints = function (
    filename,
    lineno,
    colno,
    globals,
    ...
    if (
        hasOwnPropertyDebugg(this.dbg_breakpoints, key) &&
        this.dbg_breakpoints[key].enabled === true
    ) {
        var bp = null;
        if (hasOwnPropertyDebugg(this.tmp_breakpoints, key)) {
        ...
        this.dbg_breakpoints[key].ignore_count = Math.max(
            0,
            this.dbg_breakpoints[key].ignore_count,
        );
...
Sk.Debugger.prototype.disable_breakpoint = function (filename, lineno, colno) {
    ...
    if (hasOwnPropertyDebugg(this.dbg_breakpoints, key)) {
...
Sk.Debugger.prototype.set_ignore_count = function (
    filename,
    lineno,
    colno,
    count,
...
Sk.Debugger.prototype.set_condition = function (
    filename,
    lineno,
    colno,
    lhs,
...
Sk.Debugger.prototype.set_suspension = function (suspension) {
    var parent = null;
    if (
        !hasOwnPropertyDebugg(suspension, "filename") &&
...
Sk.Debugger.prototype.add_breakpoint = function (
    filename,
    lineno,
    colno,
    temporary,
...
Sk.Debugger.prototype.asyncToPromise = function (
    suspendablefn,
    suspHandlers,
    debugger_obj,
) {
